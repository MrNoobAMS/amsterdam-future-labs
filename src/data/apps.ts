...
export const apps: AppMeta[] = [
  ...
  },
  {
    ...
    screenshots: [
      { src: '/images/apps/kamado-companion/screen-1.svg', alt: 'Kamado Companion home screen with recipe categories' },
      { src: '/images/apps/kamado-companion/screen-2.svg', alt: 'Kamado Companion recipe detail with temperatures' },
      { src: '/images/apps/kamado-companion/screen-3.svg', alt: 'Kamado Companion BBQ planner timeline' },
      { src: '/images/apps/kamado-companion/screen-4.svg', alt: 'Kamado Companion cook timers' },
    ],
    features: [
      {
        icon: 'book',
    ...
    privacy: {
      summary: 'All data stays on your device. No account, no analytics. Free and supported by ads.',
      hasAds: true,
      ...
      ads: 'Kamado Companion is free and supported by advertising. If ad personalisation is introduced, iOS will ask for your permission first via App Tracking Transparency, and this policy will be updated before that release.',
    ...
    faq: [
      { question: 'Is Kamado Companion free?', answer: 'Yes — completely free, supported by ads. No subscriptions, no paywalls, no locked recipes.' },
      ...
      { question: 'Are there ads?', answer: 'Yes — the app is free and ad-supported. Ads never block recipes or features.' },
